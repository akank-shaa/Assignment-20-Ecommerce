...
//     function handleChange(newValue, cartKey) {
//         // const newValue = +event.target.value;
//         // const cartKey = event.target.getAttribute("productid");
//         const newLocalCart = { ...localCart, [cartKey]: newValue };
